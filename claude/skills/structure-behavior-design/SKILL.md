...
Canonical content is maintained in
`codex/skills/structure-behavior-design/SKILL.md` and mirrored here for
Claude Code installation. Keep both files synchronized until a neutral
knowledge source/build step is introduced.
