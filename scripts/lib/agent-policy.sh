...
agent_policy_key_allowed() {
  case "$1" in
    MULTI_AI_ENGINES|MULTI_AI_DISABLED_ENGINES|MULTI_AI_GEMINI_APPROVAL_MODE|MULTI_AI_GEMINI_SKIP_TRUST|MULTI_AI_GEMINI_ALLOW_WRITE|MULTI_AI_CODEX_SANDBOX|MULTI_AI_CLAUDE_PERMISSION_MODE|MULTI_AI_TIMEOUT_SECONDS|MULTI_AI_ALLOW_UNSAFE_RESEARCH_MODES)
      return 0
      ;;
  esac
  return 1
