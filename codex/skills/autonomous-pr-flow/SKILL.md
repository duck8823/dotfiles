...
7. External AI delegation policy gate と local agent policy を確認し、許可される reviewer で `multi-ai-review` skill を実行する。policy deny / disabled / 認証プロンプト等で失敗した場合は理由を記録して代替 reviewer を使う
